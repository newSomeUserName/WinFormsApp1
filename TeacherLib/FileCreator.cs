...
namespace TeacherLib
{
    public class FileCreator : IDisposable
    {
        ...
        public TeachersCharacteristics ReadInfo()
        {
            ...
            TeachersCharacteristics t = new TeachersCharacteristics(fullName, 15, null);
            t.Grade.AddRange(_addGrades(5, 10));
            t.Grade.AddRange(_addGrades(4, 8));
            t.Grade.AddRange(_addGrades(3, 8));
            t.Grade.AddRange(_addGrades(2, 3));
            t.Grade.AddRange(_addGrades(1, 1));
            t.AverageGrade = 4.56;
            return t;
        }
